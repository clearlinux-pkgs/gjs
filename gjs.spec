...
Source0  : https://download.gnome.org/sources/gjs/1.78/gjs-1.78.3.tar.xz
...
%prep
%setup -q -n gjs-1.78.3
cd %{_builddir}/gjs-1.78.3
pushd ..
cp -a gjs-1.78.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1705935670
