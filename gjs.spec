...
%prep
%setup -q -n gjs-1.72.1
cd %{_builddir}/gjs-1.72.1
pushd ..
cp -a gjs-1.72.1 buildavx2
popd
...
cp %{_builddir}/gjs-1.72.1/LICENSES/BSD-3-Clause.txt %{buildroot}/usr/share/package-licenses/gjs/9950d3fdce1cff1f71212fb5abd31453c6ee2f8c
cp %{_builddir}/gjs-1.72.1/LICENSES/CC0-1.0.txt %{buildroot}/usr/share/package-licenses/gjs/8287b608d3fa40ef401339fd907ca1260c964123
cp %{_builddir}/gjs-1.72.1/LICENSES/GPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/gjs/e712eadfab0d2357c0f50f599ef35ee0d87534cb
cp %{_builddir}/gjs-1.72.1/LICENSES/GPL-3.0-or-later.txt %{buildroot}/usr/share/package-licenses/gjs/6091db0aead0d90182b93d3c0d09ba93d188f907
cp %{_builddir}/gjs-1.72.1/LICENSES/LGPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/gjs/20079e8f79713dce80ab09774505773c926afa2a
cp %{_builddir}/gjs-1.72.1/LICENSES/LGPL-2.1-or-later.txt %{buildroot}/usr/share/package-licenses/gjs/81b58c89ceef8e9f8bd5d00a287edbd15f9d3567
cp %{_builddir}/gjs-1.72.1/LICENSES/MIT.txt %{buildroot}/usr/share/package-licenses/gjs/a0193e3fccf86c17dc71e3f6c0ac0b535e06bea3
cp %{_builddir}/gjs-1.72.1/LICENSES/MPL-1.1.txt %{buildroot}/usr/share/package-licenses/gjs/c0a0e1595feceb8ecf63b095a3611d544ef9bba8
cp %{_builddir}/gjs-1.72.1/LICENSES/MPL-2.0.txt %{buildroot}/usr/share/package-licenses/gjs/67b089bde98b075d9aed0ca5a7d34c1bc78044d1
cp %{_builddir}/gjs-1.72.1/examples/test.jpg.license %{buildroot}/usr/share/package-licenses/gjs/213035d373bd94af036120780d18d42c9536f3bc
