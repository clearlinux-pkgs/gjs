...
Source0  : https://download.gnome.org/sources/gjs/1.82/gjs-1.82.0.tar.xz
...
%prep
%setup -q -n gjs-1.82.0
cd %{_builddir}/gjs-1.82.0
pushd ..
cp -a gjs-1.82.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1726595012
...
cp %{_builddir}/gjs-%{version}/subprojects/gobject-introspection-tests/COPYING %{buildroot}/usr/share/package-licenses/gjs/80fe7119545c554233bbac373a7d8b0104e45cd1 || :
cp %{_builddir}/gjs-%{version}/subprojects/gobject-introspection-tests/COPYING.GPL %{buildroot}/usr/share/package-licenses/gjs/6e0119fb857bc6287be560fecaf4bcd3f28034bf || :
cp %{_builddir}/gjs-%{version}/subprojects/gobject-introspection-tests/COPYING.LGPL %{buildroot}/usr/share/package-licenses/gjs/e963be7b84bc2a5891ab63ff87dc536b7f504695 || :
GOAMD64=v3
...
/usr/share/package-licenses/gjs/6e0119fb857bc6287be560fecaf4bcd3f28034bf
/usr/share/package-licenses/gjs/80fe7119545c554233bbac373a7d8b0104e45cd1
...
/usr/share/package-licenses/gjs/e963be7b84bc2a5891ab63ff87dc536b7f504695
