...
Source0  : https://download.gnome.org/sources/gjs/1.78/gjs-1.78.2.tar.xz
...
%prep
%setup -q -n gjs-1.78.2
cd %{_builddir}/gjs-1.78.2
pushd ..
cp -a gjs-1.78.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1704732088
