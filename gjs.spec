...
%prep
%setup -q -n gjs-1.64.4
cd %{_builddir}/gjs-1.64.4
%patch1 -p1
%patch2 -p1
...
cp %{_builddir}/gjs-1.64.4/COPYING %{buildroot}/usr/share/package-licenses/gjs/2d6aed797eaffddd3655b309f02e4956183adf0c
cp %{_builddir}/gjs-1.64.4/COPYING.LGPL %{buildroot}/usr/share/package-licenses/gjs/bf50bac24e7ec325dbb09c6b6c4dcc88a7d79e8f
