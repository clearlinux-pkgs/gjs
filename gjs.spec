...
Source0  : https://download.gnome.org/sources/gjs/1.78/gjs-1.78.4.tar.xz
...
%prep
%setup -q -n gjs-1.78.4
cd %{_builddir}/gjs-1.78.4
pushd ..
cp -a gjs-1.78.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1707762504
