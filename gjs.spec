...
Source0  : https://download.gnome.org/sources/gjs/1.66/gjs-1.66.2.tar.xz
...
%prep
%setup -q -n gjs-1.66.2
cd %{_builddir}/gjs-1.66.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1610299791
...
cp %{_builddir}/gjs-1.66.2/COPYING %{buildroot}/usr/share/package-licenses/gjs/2d6aed797eaffddd3655b309f02e4956183adf0c
cp %{_builddir}/gjs-1.66.2/COPYING.LGPL %{buildroot}/usr/share/package-licenses/gjs/bf50bac24e7ec325dbb09c6b6c4dcc88a7d79e8f
