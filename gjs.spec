...
Source0  : https://download.gnome.org/sources/gjs/1.84/gjs-1.84.2.tar.xz
Summary  : No detailed summary available
Group    : Development/Tools
License  : BSD-3-Clause CC-BY-SA-3.0 CC0-1.0 GPL-2.0 GPL-3.0 LGPL-2.0 LGPL-2.1 MIT MPL-1.1 MPL-2.0
...
%prep
%setup -q -n gjs-1.84.2
cd %{_builddir}/gjs-1.84.2
pushd ..
cp -a gjs-1.84.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1744643460
...
cp %{_builddir}/gjs-%{version}/LICENSES/CC-BY-3.0.txt %{buildroot}/usr/share/package-licenses/gjs/fb41626a3005c2b6e14b8b3f5d9d0b19b5faaa51 || :
...
cp %{_builddir}/gjs-%{version}/subprojects/gobject-introspection-tests/LICENSES/CC0-1.0.txt %{buildroot}/usr/share/package-licenses/gjs/82da472f6d00dc5f0a651f33ebb320aa9c7b08d0 || :
cp %{_builddir}/gjs-%{version}/subprojects/gobject-introspection-tests/LICENSES/GPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/gjs/3cb34cfc72e87654683f2894299adf912d14b284 || :
cp %{_builddir}/gjs-%{version}/subprojects/gobject-introspection-tests/LICENSES/MIT.txt %{buildroot}/usr/share/package-licenses/gjs/adadb67a9875aeeac285309f1eab6e47d9ee08a7 || :
GOAMD64=v3
...
/usr/share/package-licenses/gjs/3cb34cfc72e87654683f2894299adf912d14b284
...
/usr/share/package-licenses/gjs/82da472f6d00dc5f0a651f33ebb320aa9c7b08d0
...
/usr/share/package-licenses/gjs/adadb67a9875aeeac285309f1eab6e47d9ee08a7
...
/usr/share/package-licenses/gjs/fb41626a3005c2b6e14b8b3f5d9d0b19b5faaa51

%files tests
%defattr(-,root,root,-)
/V3/usr/libexec/installed-tests/gjs/libgimarshallingtests.so
/V3/usr/libexec/installed-tests/gjs/libregress.so
/V3/usr/libexec/installed-tests/gjs/libutility.so
/V3/usr/libexec/installed-tests/gjs/libwarnlib.so
