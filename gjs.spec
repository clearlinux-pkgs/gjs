...
Source0  : https://download.gnome.org/sources/gjs/1.78/gjs-1.78.1.tar.xz
...
%prep
%setup -q -n gjs-1.78.1
cd %{_builddir}/gjs-1.78.1
pushd ..
cp -a gjs-1.78.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1703273672
