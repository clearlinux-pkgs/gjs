...
Source0  : https://download.gnome.org/sources/gjs/1.58/gjs-1.58.3.tar.xz
...
%prep
%setup -q -n gjs-1.58.3
cd %{_builddir}/gjs-1.58.3
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1576602766
...
cp %{_builddir}/gjs-1.58.3/COPYING %{buildroot}/usr/share/package-licenses/gjs/2d6aed797eaffddd3655b309f02e4956183adf0c
cp %{_builddir}/gjs-1.58.3/COPYING.LGPL %{buildroot}/usr/share/package-licenses/gjs/bf50bac24e7ec325dbb09c6b6c4dcc88a7d79e8f
%make_install
